...
class TestSpeculativeAssignment:
    ...
    def test_idle_bots_get_spec_assignments(self):
        ...
        bots = [{"id": i, "position": [2 + i, 8], "inventory": []} for i in range(10)]
        items = [
    ...
    def test_far_items_assigned_first(self):
        ...
        assert "bread" in assigned_types, "Far item (bread) should be assigned for pre-pickup"
    ...
    def test_spec_assigned_bot_walks_to_target(self):
        ...
        if p.spec_assignments:
            ...
            assert result is True, "Bot with spec assignment should act on it"
