...
def test_replay_map_files_for_specific_difficulty(tmp_path: Path):
    ...
    result = benchmark._replay_map_files_for_difficulties(["Expert"], map_dir=str(tmp_path))
...
def test_replay_map_files_for_all_difficulties_returns_all_json(tmp_path: Path):
    ...
    result = benchmark._replay_map_files_for_difficulties(None, map_dir=str(tmp_path))
