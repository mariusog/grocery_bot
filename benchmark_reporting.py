...
def run_replay_game(map_path, diagnose=False):
...
def run_replay_benchmark(map_paths, verbose=False, diagnose=False):
    ...
    for map_path in map_paths:
        r = run_replay_game(map_path, diagnose=diagnose)
